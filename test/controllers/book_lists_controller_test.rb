...
class BookListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create book_list" do
    assert_difference('BookList.count') do
      post book_lists_url, params: { book_list: { author: @book_list.author, despriction: @book_list.despriction, name: @book_list.name, number_of_pages: @book_list.number_of_pages, year: @book_list.year } }
    end
  ...
  test "should update book_list" do
    patch book_list_url(@book_list), params: { book_list: { author: @book_list.author, despriction: @book_list.despriction, name: @book_list.name, number_of_pages: @book_list.number_of_pages, year: @book_list.year } }
